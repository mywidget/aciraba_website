...
<div class="content">
	<h3>Waduh.. <?= $pesan_lisensi ;?></h3>
	<?php if ($code_lisensi == "404_GCA"){
		echo '<a href="'.base_url().'auth/aktivasilisensi" class="btn btn-label-success btn-lg btn-block btn-pill"> Coba Untuk Aktivasi</a>';
	}else{
		echo '<a href="'.base_url().'" class="btn btn-label-danger btn-lg btn-block btn-pill"> Kembali Ke Halaman Masuk </a>';
	}?>
	<p>Kami tau kok, anda membutuhkan aplikasi ini untuk berbisnis. Jangan khawatir silahkan diskusi dengan kami perihal kelegalan menggunakan aplikasi ini untuk berbisnis. Lebih enak menggunakan aplikasi secara SAH / LEGAL daripada TIDAK SAH / ILLEGAL</p>
	<p style="text-align: right;">Discord : seirasetyawannn#1950 / erdepe#0809<br>WhatsApp : 082-257-808-535 / 0822-3364-1442</p>
</div>
