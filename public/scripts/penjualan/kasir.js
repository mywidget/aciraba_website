...
function panggilmeja(lantai,idElement,dari){ 
    ...
    +"<div class=\"col-md-3 card>"
            ...
            +"</div>"
                    ...
                    Swal.fire({
                        title: "222Gagal... Membaca Database",
